 ...
 */
public class TypeCRvRender implements AdapterTypeRender<ARecyclerViewHolder> {
    private RvtAdapter adapter;
    private ARecyclerViewHolder holder;

    public TypeCRvRender(Context context, RvtAdapter adapter) {
        this.adapter = adapter;
        View view = LayoutInflater.from(context).inflate(R.layout.type_c, null);
    ...
    public void bindData(int position) {
        ...
        TextView nameTv = holder.obtainView(R.id.type_c_name);
        nameTv.setText(p.getName());

        TextView ageTv = holder.obtainView(R.id.type_c_age);
